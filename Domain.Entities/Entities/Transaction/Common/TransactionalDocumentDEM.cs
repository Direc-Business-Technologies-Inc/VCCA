...
public abstract class TransactionalDocumentDEM : AuditableDEM, ITransactionalDocument
{
    ...
    /**
     * Per-table running number, generated by the database (IDENTITY column) on insert.
     * The display document number is derived by formatting this through the doc type's
     * DocumentNumberDEM config (see DocumentNumberDEM.Format).
     */
